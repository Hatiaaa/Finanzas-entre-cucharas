...
import { Search, Filter, Download, Calendar, ArrowUpCircle, ArrowDownCircle, RefreshCw, X, Pencil, Save, Upload, Trash2 } from 'lucide-react';
...
export const History: React.FC<HistoryProps> = ({ transactions, accounts, categories, onUpdateTransaction, onDeleteTransaction }) => {
  ...
  const getTypeIcon = (type: TransactionType) => {
    switch (type) {
      ...
      case TransactionType.TRANSFER: return <RefreshCw className="text-[#3b82f6]" size={18} />;
    }
  };
    ...
    <div className="space-y-6 animate-fade-in relative">
      ...
      {editingTx && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="bg-[#1c1c24] rounded-2xl shadow-xl w-full max-w-2xl p-6 animate-fade-in max-h-[90vh] overflow-y-auto border border-gray-800">
             <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-4">
               <h3 className="text-xl font-bold text-white flex items-center gap-2">
                 <Pencil size={20} className="text-[#6c5dd3]"/> Editar Movimiento
               </h3>
             ...
             <form onSubmit={handleSaveEdit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl bg-[#13131a] border border-gray-700 p-2 text-white focus:ring-1 focus:ring-[#6c5dd3] outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full rounded-xl bg-[#13131a] border border-gray-700 p-2 text-white focus:ring-1 focus:ring-[#6c5dd3] outline-none disabled:opacity-50"
                        >
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-800">
                  <button type="button" onClick={() => setEditingTx(null)} className="px-5 py-2 text-gray-400 bg-gray-800 rounded-lg hover:bg-gray-700 font-medium">Cancelar</button>
                  <button type="submit" className="px-5 py-2 text-white bg-[#6c5dd3] rounded-lg hover:bg-[#5b4eb8] font-medium flex items-center gap-2">
      ...
      <div className="bg-[#1c1c24] p-5 rounded-3xl shadow-lg border border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            <Filter size={20} className="text-[#6c5dd3]" />
            Filtros de Búsqueda
          </h3>
          <div className="flex gap-2">
            ...
            <button 
              onClick={downloadCSV}
              className="flex items-center gap-2 bg-[#6c5dd3] text-white px-4 py-2 rounded-xl text-sm font-bold hover:bg-[#5b4eb8] transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="lg:col-span-1 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-[#13131a] border border-gray-700 rounded-xl text-sm text-white focus:ring-1 focus:ring-[#6c5dd3] focus:border-[#6c5dd3] outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-2 lg:col-span-2">
             <div className="relative w-full">
                ...
                <input 
                  ...
                  className="w-full pl-8 pr-2 py-2 bg-[#13131a] border border-gray-700 rounded-xl text-sm text-white focus:ring-1 focus:ring-[#6c5dd3] outline-none"
                />
             </div>
          ...
          <div className="lg:col-span-1">
            <select
              ...
              className="w-full px-3 py-2 bg-[#13131a] border border-gray-700 rounded-xl text-sm text-white focus:ring-1 focus:ring-[#6c5dd3] outline-none"
            >
      ...
      {/* --- Tabla de Resultados --- */}
      <div className="bg-[#1c1c24] rounded-3xl shadow-lg border border-gray-800 overflow-hidden">
        <div className="p-6 border-b border-gray-800 flex justify-between items-center">
          <span className="font-bold text-white text-lg">Resultados</span>
          <span className="text-xs text-gray-400 bg-[#13131a] px-3 py-1 rounded-full border border-gray-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#13131a] text-gray-500 text-xs uppercase tracking-wider border-b border-gray-800">
                    ...
                    <tr key={t.id} className="hover:bg-white/5 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-400">
                        <div className="flex flex-col items-start">
                          <span className="px-2 py-1 bg-[#13131a] border border-gray-700 rounded-md text-xs">
                            {t.category}
                          </span>
                          {t.subcategory && (
                      ...
                      <td className={`px-6 py-4 text-sm font-bold text-right whitespace-nowrap ${
                        t.type === TransactionType.INCOME ? 'text-[#10b981]' : 
                        t.type === TransactionType.EXPENSE ? 'text-[#ef4444]' : 'text-[#3b82f6]'
                      }`}>
                      ...
                      <td className="px-6 py-4 text-sm text-center">
                        <div className="flex items-center justify-center gap-1">
                          <button 
                            ...
                            className="text-gray-500 hover:text-[#6c5dd3] transition-colors p-2 rounded-full hover:bg-white/5"
                            title="Editar"
                          >
                            <Pencil size={16} />
                          </button>
